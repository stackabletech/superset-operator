...
Expand the name of the chart.
*/}}
{{- define "superset-operator.appname" -}}
...
app.kubernetes.io/name: {{ include "superset-operator.appname" . }}
...
{{- default (printf "%s-serviceaccount" (include "superset-operator.fullname" .)) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "superset-operator.testLabels" -}}
helm.sh/test: {{ include "superset-operator.chart" . }}
{{- end }}
