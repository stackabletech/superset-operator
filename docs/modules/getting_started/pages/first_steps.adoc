...
Once you have followed the steps in  xref:installation.adoc[] for the Operator and its dependencies, you will now go through the steps to set up and connect to a Superset instance.
