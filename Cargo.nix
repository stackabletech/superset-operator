    ...
    crates = {
      ...
      "k8s-version" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "8a356727fa067e3af1114ca655976c1fbea9b57c";
          sha256 = "1jxj3xbqqsxwhxpjs01sgpmgqwym22df9hbpzw57b6lr1p2ix7cw";
        };
        libName = "k8s_version";
        authors = [
      ...
      "rustls" = rec {
        ...
        version = "0.23.24";
        edition = "2021";
        sha256 = "1zil3gg3wy1zn0jj890m9f68ribijxp7x51b1a14bh0v7fan3gwn";
        dependencies = [
          {
            name = "log";
            packageId = "log";
